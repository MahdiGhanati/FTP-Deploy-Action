...
function deploy(args, logger, timings) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        logger.all(`by giving it a ⭐ on Github --> https://github.com/MahdiGhanati/FTP-Deploy-Action`);
        logger.all(`or add a badge 🏷️ to your projects readme --> https://github.com/MahdiGhanati/FTP-Deploy-Action#badge`);
...
exports.syncFileDescription = "DO NOT DELETE THIS FILE. This file is used to keep track of which files have been synced in the most recent deployment. If you delete this file a resync will need to be done (which can take a while) - read more: https://github.com/MahdiGhanati/FTP-Deploy-Action";
var ErrorCode;
(function (ErrorCode) {
